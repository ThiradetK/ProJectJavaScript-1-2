...
const account3 = {
  ...
  movements: [50000, 34000, -500, -250, 3500, 10000, 85000, -500],
  interestRate: 1.25,
  pin: 3333,
...
// console.log(parseFloat(' 2.5rem ')); // JavaScript แบบเก่า
...
console.log('check if value integer');
...
// Rounding Decimals
console.log((2.7).toFixed(0)); // ค่าที่ได้จะเป็น String
console.log((2.7).toFixed(3));
console.log((2.345).toFixed(2));
console.log(+(2.345).toFixed(2)); // คืนค่าออกมาเป็น Number
*/
...
// Working with BigInt
console.log(2 ** 53 - 1);
console.log(Number.MAX_SAFE_INTEGER); // ตัวเลขมาสุดใน JavaScript ที่คำนวณแล้วได้ตรง มากกว่านี้จะเพี้ยน
console.log(2 ** 53);
console.log(2 ** 53 + 1);
console.log(2 ** 53 + 2);
console.log(2 ** 53 + 3);
...
console.log(45511316874684512845132864512n);
console.log(BigInt(4551131));

// Operations
console.log(10000n + 10000n);
console.log(3213213213213216545465321465465133545n * 10000000n);
...
console.log(new Date('Sat Feb 22 2025 15:43:06'));
...
///////////////////////////////////////////////////////////////////////
// Internationalizing Dates (Intl) Part_1
/*
///////////////////////////////////////////////////////////////////////
// Internationalizing Dates (Intl) Part_2
const num = 3887764.23;
